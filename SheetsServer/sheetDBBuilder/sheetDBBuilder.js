...
var SheetDBBuilder = (function () {
    ...
    SheetDBBuilder.prototype.connectAndOpen = function () {
        ...
        db.once('open', function () {
            ...
            _this.createSchemaAndFill();
        });
    };
    SheetDBBuilder.prototype.createSchemaAndFill = function () {
        var sheetSchema = new mongoose.Schema(this.getSheetSchema());
        var SheetModel = mongoose.model('SheetModel', sheetSchema);
        var sheetJSONs = this.getSheetJSONs();
        for (var i = 0; i < sheetJSONs.length; i++) {
            ...
            var oneSheetModel = new SheetModel(sheetJSONs[i]);
    ...
    SheetDBBuilder.prototype.getSheetSchema = function () {
